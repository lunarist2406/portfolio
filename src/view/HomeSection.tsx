...
export default function HomeView() {
  return (
    <section id="home" className="min-h-screen bg-black flex items-center py-24 px-4 overflow-hidden relative">
      {/* Background Decor - Tạo chiều sâu cho UI */}
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            >
              ...
              <span className="text-zinc-400 text-xs font-medium uppercase tracking-wider">Available for new projects</span>
            </motion.div>
            ...
            <div className="space-y-4">
              ...
              >
                Lập trình <br /> 
                <span className="text-yellow-500 italic">Trải nghiệm</span>
              </motion.h1>
              <motion.p
              ...
              >
                Tôi là <span className="text-white font-bold">{homeData.name}</span>. {homeData.description}
              </motion.p>
            </div>
            ...
            >
              {[
                { icon: Github, link: homeData.github },
                { icon: Linkedin, link: homeData.linkedin },
                { icon: Mail, link: `mailto:${homeData.email}` }
              ].map((social, i) => (
                <a
                  key={i}
                  href={social.link}
              ...
              <div className="w-72 h-72 md:w-96 md:h-96 relative z-10">
                ...
                >
                  ...
                  <div className="text-[10px] text-zinc-400 uppercase font-bold mt-1 tracking-wider">
                    {homeData.stats.expLabel}
                  </div>
                </motion.div>

                {/* Optional: Thêm một badge nữa cho số dự án nếu Mỹ muốn */}
                <motion.div 
