export default function Banner() {
  return (
    <div className="bg-black text-white py-20 flex flex-col items-center justify-center h-screen relative overflow-hidden">
      <div className="2/4 w-full h-full flex items-center justify-center relative "></div>
      <div className="content">
      <section className="bg-black text-white py-20 px-6 text-center">
  <h1 className="text-5xl font-bold text-yellow-400 mb-4">Chào bạn, tôi là Tô</h1>
