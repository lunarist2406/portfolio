...
const content = "              Một lập trình viên đam mê công nghệ, yêu thích việc tạo ra những sản phẩm sáng tạo, tinh tế và hiệu quả. Tôi không chỉ viết code,tôi kiến tạo trải nghiệm!"
        ...
        <div className="w-1/2 h-full flex items-center justify-center">
          <section className="text-left">
            ...
            <p className="text-xl mb-6 max-w-md">
              Một lập trình viên đam mê công nghệ, yêu thích việc tạo ra những
              sản phẩm sáng tạo, tinh tế và hiệu quả. Tôi không chỉ viết code,
